            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="form-control" value="{{ old('title') }}" placeholder="e.g. 10 Best Workouts for Beginners" required>
                        @error('title') <span class="text-danger small">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold">Slug (Optional - auto-generated)</label>
                        <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug') }}" placeholder="e.g. 10-best-workouts-for-beginners">
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title') }}" placeholder="Optimized title for search engines">
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-bold">Meta Description</label>
                        <textarea name="meta_description" class="form-control" rows="3" placeholder="Brief summary of the blog...">{{ old('meta_description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="seo-keywords-container">
                            @php
                                $existingKeywords = old('meta_keywords', []);
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <small class="text-muted d-block mt-2">Recommended size: 1200 x 630 pixels. Use WebP for better performance.</small>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <input type="text" name="pincode" class="form-control" value="{{ old('pincode') }}" placeholder="e.g. 400001">
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body d-grid gap-2">
                    <button type="submit" class="btn btn-primary py-2 fs-6">
                        <i class="ti ti-device-floppy"></i> Save Blog Post
                    </button>
