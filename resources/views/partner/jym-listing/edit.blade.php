                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="url" name="instagram_link" class="form-control" placeholder="https://instagram.com/yourgym" value="{{ old('instagram_link', $gym->instagram_link) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Facebook Link</label>
                                    <input type="url" name="facebook_link" class="form-control" placeholder="https://facebook.com/yourgym" value="{{ old('facebook_link', $gym->facebook_link) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">YouTube Link</label>
                                    <input type="url" name="youtube_link" class="form-control" placeholder="https://youtube.com/@yourgym" value="{{ old('youtube_link', $gym->youtube_link) }}">
                                </div>
                            </div>
                        </div>
               <br>
