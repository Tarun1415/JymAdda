...
<div class="row justify-content-center">
    <div class="col-lg-10 col-xl-8">
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="fw-bold mb-0">Add New Gym Member</h4>
        </div>

        <div class="card shadow-sm border-0">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('Partnerjym.members.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control ui-input" placeholder="e.g. Rahul Kumar" value="{{ old('name') }}" required>
                            @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Mobile Number <span class="text-danger">*</span></label>
                            <input type="text" name="mobile" class="form-control ui-input" placeholder="10-digit number" value="{{ old('mobile') }}" required pattern="[0-9]{10}">
                            @error('mobile') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Aadhar Card Number (Optional)</label>
                            <input type="text" name="adhar_no" class="form-control ui-input" placeholder="12-digit Aadhar" value="{{ old('adhar_no') }}">
                            @error('adhar_no') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        
                        <div class="col-12">
                            <label class="form-label fw-bold">Full Address (Optional)</label>
                            <textarea name="address" class="form-control ui-textarea" rows="2" placeholder="Local address">{{ old('address') }}</textarea>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <select name="plan_duration" class="form-select ui-input" required>
                                ...
                                <option value="1 Month" {{ old('plan_duration') == '1 Month' ? 'selected' : '' }}>1 Month</option>
                                <option value="3 Months" {{ old('plan_duration') == '3 Months' ? 'selected' : '' }}>3 Months</option>
                                <option value="6 Months" {{ old('plan_duration') == '6 Months' ? 'selected' : '' }}>6 Months</option>
                                <option value="1 Year" {{ old('plan_duration') == '1 Year' ? 'selected' : '' }}>1 Year</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="start_date" class="form-control ui-input" value="{{ old('start_date', date('Y-m-d')) }}" required>
                            @error('start_date') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold">Total Fees (₹) <span class="text-danger">*</span></label>
                            <input type="number" id="total_fees" name="total_fees" class="form-control ui-input" value="{{ old('total_fees', 0) }}" min="0" required onkeyup="calculatePending()">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" id="amount_paid" name="amount_paid" class="form-control ui-input" value="{{ old('amount_paid', 0) }}" min="0" required onkeyup="calculatePending()">
                            @error('amount_paid') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold text-danger">Pending Dues (₹) (Auto)</label>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <select name="status" class="form-select ui-input" required>
                                ...
                                <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>Pending/Hold</option>
                            </select>
                    ...
                    <div class="text-end border-top pt-4">
                        <button type="submit" class="btn btn-primary px-5 py-2 fw-bold" style="border-radius: 12px;">Save & Add Member</button>
                    </div>
                </form>
            </div>
        </div>
