<!-- Custom Premium Footer for GymAdda -->
<style>
  .site-footer {
    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-brand">
                    <a href="{{ url('/') }}" class="footer-logo">
                        <img src="{{ asset('images/favicon.png') }}" alt="Logo" onerror="this.src='{{ asset('images/logo.png') }}';">
                        <span class="footer-logo-text">GymAdda</span>
                    </a>
                    <p class="footer-desc">
                        Empowering fitness enthusiasts to find the perfect gym, and building smart CRM tools for Gym owners to automate their business.
                    </p>
                ...
                <div class="footer-widget">
                    ...
                    <ul class="footer-contact">
                        ...
                        <li>
                            ...
                            <a href="mailto:support@gymadda.com">support@gymadda.com</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <p class="copyright-text">
                &copy; {{ date('Y') }} GymAdda Platform. All Rights Reserved.
            </p>
